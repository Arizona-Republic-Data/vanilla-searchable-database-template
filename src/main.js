 ...
 *   transformation in the preprocessing script instead of at runtime. DON'T WORRY ABOUT THIS ONE.
 ...
 *   sort in the table.
 * @property {Map} renderFuncs - Functions used to render columns in the table. DON'T WORRY ABOUT THIS ONE
...
export class SearchableDatabase {
  ...
  //Add elements to this array if you want to preprocess your data.
  ...
  displayHeadings = new Map([
    ["name_in_data", "Name for Public Facing App"],
    ["name_in_data", "Name for Public Facing App"],
    ["name_in_data", "Name for Public Facing App"],
    ["name_in_data", "Name for Public Facing App"],
  ]);
  ...
  sortable = new Set(["column_that_you_want_to_be_sortable", "another_column_that_you_want_to_be_sortable"]);
   // DON'T NEED TO CHANGE THIS VARIABLE
...
/** Here, you'll want to change the 'data-field-name' to match what you have going on in your css. 
 * So, for example, the 'complaint-date' data field name matches the 'complaint-date' css attribute  
 * this ensures that complaint date transfers between being a column and being in the dropdown menu when we resize the iframe 
 * if you need more fields, just copy over one of the <div></div> tags and everything that's inside it, replace the data-field-name with a new one
 * replace the colname with the name of the column you want represented, and the 'colname' in ${record.colname} with the name of the field 
 ...
 */
   ...
   * Np need to change any of this code
   */
  sendHeight() {
    if (this.resizer) {
