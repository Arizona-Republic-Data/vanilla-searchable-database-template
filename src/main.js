...
export class SearchableDatabase {
  ...
  async init() {
    ...
    if (!this.renderFuncs.has(this.idCol)) {
      ...
      this.renderFuncs.set(this.idCol, SearchableDatabase.renderToggleDetailCol);
    }
  ...
  processData() {
    this.records.forEach((record, i) => {
      ...
      record = SearchableDatabase.transformColumns(record, this.columnTransforms);
  ...
  initCategoryFilter(categoryColIdx) {
    ...
    this.selectEl.addEventListener("change", (evt) => {
      ...
      if (selectedCategory === "") {
        ...
        this.table.setFilter(
          SearchableDatabase.filterByCategory.bind(null, selectedCategory, categoryColIdx)
        );
  ...
  connectDetailButtonHandlers(handler) {
    ...
    this.table.container.querySelectorAll("button.show-detail").forEach((el) => {
  ...
  initTableEvents() {
    ...
    this.table.on("datatable.page", () => {
      SearchableDatabase.closeAllDetails(this.table.container.querySelector("tbody"));
      this.connectDetailButtonHandlers(buttonHandler);
    });
